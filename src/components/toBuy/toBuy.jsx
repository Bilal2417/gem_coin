            ...
            <Box className="section-head">
              ...
              <Box>
                ...
                <Typography
                  ...
                  className="section-mini-heading"
                  variant="body1"
                >
                  Buy in 3 steps
                </Typography>
                  ...
                  <Box className="buy-text-block">
                    <Box className="quaternary-head-block">
                      <Typography
                        ...
                        variant="h3"
                        className="quaternary-heading heading-grd"
                      >
                        connect your wallet
                      </Typography>
                    </Box>
                    <Box className="text-block">
                      ...
                      >
                        Click on „Connect Wallet“ and open your decentralized
                        wallet to verify! Make sure you are on the Ethereum
                        Network and have some ETH for fees ready.
                      </Typography>
                    </Box>
                  </Box>
                </Grid>
                  ...
                  <Box className="buy-text-block">
                    <Box className="buy-text-head">
                      <Typography
                        ...
                        variant="h3"
                        className="buy-text-heading heading-grd"
                      >
                        Enter the amount
                      </Typography>
                    </Box>
                    <Box className="text-block">
                      ...
                      >
                        Either enter the amount of you wish to receive or the
                        amount of USDT or ETH you want to spend.
                      </Typography>
                    </Box>
                  </Box>
                </Grid>
                ...
                >
                  ...
                  <Box className="buy-text-block">
                    ...
                    <Box className="text-block">
                      ...
                      >
                        Now click on „Confirm“ and verify the transaction inside
                        your wallet! Now wait for the presale to finish and come
